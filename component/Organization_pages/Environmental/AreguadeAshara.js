...
class AreguadeAshara extends Component {
    render() {
        return (
 <div>
            <AboveHeader/>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-12">
                        <h2>Environment Merja Organization</h2>
                ...
                <div className="row">
                    <div className="col-lg-8">
                        <div className="single-content">
                            <img src="img/environmental1.jpg" />
                            <h2>Help environment:Help Ethiopia</h2>
                            <p>
                               Environment Merja organizations is was established in 1998 by 
                               the 
                               </p>
                            <p>
                                ...
                                <div className="recent-post">
                                    <div className="post-item">
                                        ...
                                        <div className="post-text">
                                            <a href="">this from gergeson environment</a>
