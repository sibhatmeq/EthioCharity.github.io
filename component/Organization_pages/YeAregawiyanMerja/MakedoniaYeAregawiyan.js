...
class MakedoniaYeAregawiyan extends Component {
    render() {
        return (
 <div>
            <AboveHeader/>
                ...
                <div className="row">
                    <div className="col-lg-8">
                        <div className="single-content">
                            ...
                            <p>
                               GergesonYeFestula Merja organizations is was established in 1998 by 
                               the 
                               </p>
                            <p>
                                ...
                                <div className="recent-post">
                                    <div className="post-item">
                                        ...
                                        <div className="post-text">
                                            <a href="">this from gergeson YeFestulaMerja</a>
...
export default MakedoniaYeAregawiyan;
