...
class MakedoniaYeFestula extends Component {
    render() {
        return (
            <div>
                <AboveHeader/>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-12">
                        <h2>MakedoniaYeEnatoch Merja Organization</h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div className="row">
                    <div className="col-lg-8">
                        <div className="single-content">
                            ...
                            <p>
                               MakedoniaYeEnatoch Merja organizations is was established in 1998 by 
                               the 
                               </p>
                            <p>
...
export default MakedoniaYeFestula;
