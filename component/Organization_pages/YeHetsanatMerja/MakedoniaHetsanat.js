...
class MakedoniaHetsanat extends Component {
    render() {
        return (
 <div>
            <AboveHeader/>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-12">
                        <h2>GergesonYeFestula Merja Organization</h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div className="row">
                    <div className="col-lg-8">
                        ...
                        <div className="single-tags">
                            <a href="">kotebe YeFistulaMerja</a>
                        </div>
                                ...
                                <div className="recent-post">
                                    <div className="post-item">
                                        ...
                                        <div className="post-text">
                                            <a href="">this from gergeson YeFistulaMerja</a>
...
export default MakedoniaHetsanat;
