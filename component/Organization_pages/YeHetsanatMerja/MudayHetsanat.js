...
class MudayHetsanat extends Component {
    render() {
        return (
 <div>
            <AboveHeader/>
                ...
                <div className="row">
                    <div className="col-lg-8">
                        <div className="single-content">
                            <img src="img/merryjoy.jpg" />
                            <h2>help child save world</h2>
                            <p>
                               GergesonYeFestula Merja organizations is was established in 1998 
                               this is time gergeson help more than 500 mothers and other childers.
                                ...
                                <div className="recent-post">
                                    <div className="post-item">
                                        ...
                                        <div className="post-text">
                                            <a href="">this from MudayHetsanat</a>
